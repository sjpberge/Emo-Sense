...
def video_dash():
    ...
    model.fit(x=[x_train[:, 0], x_train[:, 1]], y=y_train, batch_size=64, epochs=3, verbose=1,
    ...
    filtered_recommendations = filter_movie_recommendations_by_emotion(recommended_movie_ids, emotion, movie_df)
